"""
BaseExactPermitFacilitatorMechanism - "exact_permit" facilitator base class.
...
from bankofai.x402.utils import convert_permit_to_eip712_message, payment_id_to_bytes
